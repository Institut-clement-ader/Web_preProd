  ...
  <div id="header-region" class="clear-block"></div> 
    ...
    <div id="container" class="clear-block"> 
     <div id="header"> 
        ...
        <div id="titol-lacan"> 
          <a href="http://ica.preprod.lamp.cnrs.fr/projets/icare/" title="ANR ICARE"><div id="header-text-lacan"> <h5>Projet VERTEX</h5></a>
</div></div> 
        <div id="titol-upc"> 
            <a href="http://ica.preprod.lamp.cnrs.fr/projets/vertex" title="ANR Vertex"><div id="header-text-upc">VERTEX ANR-12-RMNP-0001</div></a>
...
<ul class="links primary-links"><li class="menu-176 first"><a href="/projets/vertex/" title="Home link">Accueil</a></li> 
<li class="menu-166"><a href="index.php?id=results" title="See the results">Résultats</a></li> 
<li class="menu-166"><a href="index.php?id=envols" title="See envols">Envols</a></li> 
...
case "envols" : include("envols.inc");break;
