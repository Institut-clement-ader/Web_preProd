  ...
  <div id="header-region" class="clear-block"></div> 
    ...
    <div id="container" class="clear-block"> 
     <div id="header"> 
        ...
        <div id="titol-lacan"> 
          <a href="http://ica.preprod.lamp.cnrs.fr/projets/icare/" title="ANR VULCOMP"><div id="header-text-lacan"> <h5>Projet VULCOMP 2</h5></a>
</div></div> 
        <div id="titol-upc"> 
            <a href="http://ica.preprod.lamp.cnrs.fr/projets/vulcomp2" title="ANR Vulcomp 2"><div id="header-text-upc">VULCOMP2 ANR-12-RMNP-0018</div></a>
