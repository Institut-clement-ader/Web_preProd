<?php
// $Id: month.php 2790 2013-11-26 09:25:57Z cimorrison $
...
else
{
   ...
   {
   $str_respo1 = " <a href=\"http://ica.preprod.lamp.cnrs.fr/". htmlspecialchars("$this_room_admin1") ."\">";
   }
...
else
{
   ...
   {
   $str_respo2 = " - <a href=\"http://ica.preprod.lamp.cnrs.fr/". htmlspecialchars("$this_room_admin2") ."\">";
   }
...
else
{
   ...
   {
   $str_respo3 = " - <a href=\"http://ica.preprod.lamp.cnrs.fr/". htmlspecialchars("$this_room_admin3") ."\">";
   }
...
echo $str_respo;
//echo "<h3> Responsable(s) : <a href=\"http://ica.preprod.lamp.cnrs.fr/". htmlspecialchars("$this_room_admin1") ."\">".htmlspecialchars("$this_room_admin1")."</a> </h3>\n";
echo "</div>\n";
