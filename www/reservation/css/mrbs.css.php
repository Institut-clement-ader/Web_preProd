...
// $Id: mrbs.css.php 2837 2014-05-09 11:29:36Z cimorrison $
...
/*div#dwm_header {width: 80%; margin:auto}*/
div#dwm_areas, div#dwm_rooms  {float: left; margin-right: 2.0em}
#dwm_header h3 {font-size: small; font-weight: normal; 
...
div#dwm_avertissement {width: 50%; margin:auto}
#dwm_avertissement h3 {font-size: medium; font-weight: normal; font-style: italic; color:#FF0000 ;
    margin-top: 0.5em; margin-bottom: 0.5em; padding-bottom: 0; text-align:center; border: 1px solid red}

div#dwm {margin-bottom: 1em}
/*div#dwm {margin:auto}*/
#dwm {text-align: center}
#dwm h2 {font-size:large; font-weight:bold; margin-bottom: 0; margin-top: 1em}
#dwm h3 {font-size: small; font-weight: normal; 
    margin-top: 0; margin-bottom: 0.5em; padding-bottom: 0}
#dwm div.timezone {opacity: 0.8}

div.date_nav    {  width: 100%; margin:auto; font-weight: bold}
...
table#banner {width: 100%; margin:auto; border-spacing: 0; border-collapse: collapse;
...
#trailer div {float: left; width: 90%}
#trailer div.trailer_label {float: left; clear: left; width: 20%; max-width: 15.0em; font-weight: bold}
...
div#simple_trailer {clear: both; text-align: center; padding-top: 1.0em; padding-bottom: 2.0em; width: 80%; margin:auto}
